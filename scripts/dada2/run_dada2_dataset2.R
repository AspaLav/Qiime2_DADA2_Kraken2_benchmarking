# Standalone DADA2 workflow for Dataset 2
# Dataset: dataset_02_miseq_v1v2_mock_cells_rbb_glycerol
# Run: SRR3225702
...
cat("DADA2 workflow completed for Dataset 2:", dataset, "\n")